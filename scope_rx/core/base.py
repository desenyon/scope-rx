...
class ExplanationResult:
    ...
    def to_heatmap(
        ...
        heatmap: NDArray[np.uint8] = cv2.applyColorMap(heatmap_arr, colormap_cv2)  # type: ignore[call-overload]
...
class BaseExplainer(ABC):
    ...
    def __init__(
        ...
        # Wrapper
        self.wrapper = ModelWrapper(self.model, self.device)
    ...
    def _find_layer(
        ...
        """
        return self.wrapper.get_layer(layer_name)
...
class AttributionContext:
    ...
    def __exit__(
        ...
        # Implicitly return None, which is falsy, so exceptions propagate
